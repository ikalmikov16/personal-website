...
const AppleIcon = () => (
  <svg width="14" height="17" viewBox="0 0 496 608" fill="currentColor">
    <path d="M411.5 217.9c-2.9 2.2-54.1 31.1-54.1 95.3 0 74.2 65.1 100.4 67.1 101.1-.3 1.6-10.4 35.9-34.4 70.9-21.4 30.8-43.7 61.5-77.7 61.5s-42.7-19.8-82-19.8c-38.2 0-51.8 20.4-82.9 20.4s-52.8-28.7-77.7-63.7C40.5 442.3 16.4 378.5 16.4 317.9c0-97.2 63.2-148.7 125.4-148.7 33.1 0 60.6 21.7 81.3 21.7 19.8 0 50.6-23 88.2-23 14.2 0 65.4 1.3 99.2 49.6zM293.6 126.3c15.5-18.5 26.5-44.1 26.5-69.6 0-3.6-.3-7.1-.9-10.1-25.3.9-55.4 16.8-73.5 37.9-14.3 16.2-27.6 41.8-27.6 67.7 0 3.9.6 7.8.9 9 1.6.3 4.2.6 6.8.6 22.7 0 51.4-15.2 67.8-35.6z" />
  </svg>
)
